...
class Problem2Solver():
    ...
    'JYW', 'PLX', 'QVE', 'BLR', 'OGU', 'BSN', 'VML', 'KKG', 'VND', 'NDG', 'PFK', 'MUF', 'QRK', 'GYV', 'CBT', 'YHW', 'HHK', 'XIT', 'GYJ', 'YUZ', 'DYE', 'ZEW', 'ZLX', 'FRE', 'GFQ', 'XPV', 'YGC', 'ESY', 'FUR', 'IFL', 'PQS', 'KRZ', 'OED', 'FCY', 'XCS', 'IES', 'QTY', 'CQD', 'XYR', 'LPQ', 'DUR', 'XAD', 'EGV', 'LKB', 'VSL', 'NYO', 'IUE', 'AGW', 'NNA', 'RGG', 'XZR', 'ROP', 'MAS', 'PUO', 'BWU', 'LDU', 'UWD', 'PMS', 'ZSI', 'NBQ', 'KAA', 'FFA', 'ILW', 'WTJ', 'VTN', 'XFD', 'CUN', 'IUQ', 'IMC', 'NSL', 'JCR', 'WAG'
    'VG', 
